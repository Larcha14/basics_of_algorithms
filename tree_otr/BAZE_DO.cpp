...
struct segtree{
    ...
    segtree( const vector<int>&a):segtree(a.size()) {build(1, 1, n, a);}
    ...
    void build(int id, int l, int r, const vector<int> &a){
        ...
        data[id]=min(data[id*2], data[id*2 +1]);  // создание дерева
    }
